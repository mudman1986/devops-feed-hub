...
The repository is structured to support **future extraction** of reusable components (like the RSS feed collector action) to separate repositories while keeping workflow-specific logic in this repository.
...
These scripts are **workflow-specific** and will stay in this repository when the action is extracted.
