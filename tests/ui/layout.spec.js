...
test.describe('Desktop Layout Tests', () => {
  ...
  test('header should be visible and properly aligned @desktop', async ({ page }) => {
  ...
  test('feed sections should display with proper spacing @desktop', async ({ page }) => {
  ...
  test('timeframe selector should be visible and functional @desktop', async ({ page }) => {
...
test.describe('Mobile Layout Tests', () => {
  ...
  test('sidebar should be collapsed by default on mobile @mobile', async ({ page }) => {
    const sidebar = page.locator('#sidebar')
  ...
  test('mobile navigation toggle should be visible @mobile', async ({ page }) => {
    const navToggle = page.locator('#nav-toggle')
  ...
  test('buttons should be touch-friendly on mobile @mobile', async ({ page }) => {
    const themeToggle = page.locator('#theme-toggle')
    await expect(themeToggle).toBeVisible()
