...
test.describe('Sidebar Toggle Tests', () => {
  ...
  test('should toggle sidebar when clicking nav toggle @mobile', async ({ page }) => {
  ...
  test('should close sidebar when clicking outside @mobile', async ({ page }) => {
    const navToggle = page.locator('#nav-toggle')
    const sidebar = page.locator('#sidebar')
...
test.describe('Mark as Read Tests', () => {
  ...
  test('should mark article as read when clicking indicator', async ({ page }) => {
  ...
  test('should toggle read status when clicking indicator twice', async ({ page }) => {
    const readIndicators = page.locator('.read-indicator')
  ...
  test('should clear all read articles when clicking reset button', async ({ page }) => {
    const readIndicators = page.locator('.read-indicator')
    const resetButton = page.locator('#reset-read-button')
    
    if (await readIndicators.count() === 0 || await resetButton.count() === 0) {
      test.skip()
    }
